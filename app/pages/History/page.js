      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <h2 className="text-xl font-semibold mb-4 text-green-700">
            Approved Items <span className="text-base text-gray-600">({filteredApproved.length})</span>
          </h2>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4 text-red-700">
            Rejected Items <span className="text-base text-gray-600">({filteredRejected.length})</span>
          </h2>
